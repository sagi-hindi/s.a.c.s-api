...
router.get("/products", function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
    var qNew, qCategory, users, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, products_logic_1.default.getAllProducts(qNew, qCategory)];
            case 1:
                users = _a.sent();
                response.json(users);
                return [3 /*break*/, 3];
...
router.post("/products/add", function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
...
router.put("/products/update/:id", verify_admin_1.default, function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
    var updateProduct, err_4;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                request.body.image = (_a = request.files) === null || _a === void 0 ? void 0 : _a.image;
                return [4 /*yield*/, products_logic_1.default.updateProduct(request.body)];
            case 1:
